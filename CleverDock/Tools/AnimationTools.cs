...
public class AnimationTools
{
    ...
    public static void Collapse(double seconds, int finalWidth, FrameworkElement element, Action completed = null,
        double delay = 0)
    {
    ...
    public static void ExpandX(double seconds, int finalWidth, FrameworkElement element, Action completed = null,
        double delay = 0)
    {
        var collapse = new DoubleAnimation
        {
    ...
    public static void TranslateY(double seconds, double to, DependencyProperty property, FrameworkElement element,
