...
internal class IconInterop
{
        ...
        /// <summary>
        ///     Modify SHGFI_ICON, causing the function to retrieve the file's large icon (32x32). The SHGFI_ICON flag must also be
        ///     set.
        /// </summary>
        public const int SHGFI_LARGEICON = 0x0;

        /// <summary>
        ///     Modify SHGFI_ICON, causing the function to retrieve the file's small icon (16x16). The SHGFI_ICON flag must also be
        ///     set.
        /// </summary>
        public const int SHGFI_SMALLICON = 0x1;

        /// <summary>
        ///     Used by SHGetImageList. These images are the Shell standard extra-large icon size. This is typically 48x48, but the
        ///     size can be customized by the user.
        /// </summary>
    ...
    public struct IMAGEINFO
    {
            ...
            /// <summary>
            ///     A handle to a monochrome bitmap that contains the masks for the images. If the image list does not contain a mask,
            ///     this member is NULL.
            /// </summary>
    ...
    public struct IMAGELISTDRAWPARAMS
    {
            ...
            ///     When used with ILS_ALPHA, this member holds the value for the alpha channel. This value can be from 0 to 255, with
            ///     0 being completely transparent, and 255 being completely opaque.
            ...
            /// <summary>
            ///     A color used for the glow and shadow effects. You must use comctl32.dll version 6 to use this member. See the
            ///     Remarks.
            /// </summary>
            public int crEffect;

            /// <summary>
            ///     A value that specifies the number of pixels to draw, relative to the upper-left corner of the drawing operation as
            ///     specified by xBitmap and yBitmap. If cx and cy are zero, then Draw draws the entire valid section. The method does
            ...
            /// <summary>
            ///     A value specifying a raster operation code. These codes define how the color data for the source rectangle will be
            ///     combined with the color data for the destination rectangle to achieve the final color. This member is ignored if
            ///     fStyle does not include the ILD_ROP flag.
            /// </summary>
            public int dwRop;
            ...
            /// <summary>
            ///     A flag specifying the drawing style and, optionally, the overlay image. See the comments section at the end of this
            ///     topic for information on the overlay image.
            /// </summary>
            public int fStyle;
            ...
            /// <summary>
            ///     The x-coordinate that specifies the upper-left corner of the drawing operation in reference to the image itself.
            ///     Pixels of the image that are to the left of xBitmap and above yBitmap do not appear.
            /// </summary>
            public int xBitmap;
            ...
            /// <summary>
            ///     The y-coordinate that specifies the upper-left corner of the drawing operation in reference to the image itself.
            ///     Pixels of the image that are to the left of xBitmap and above yBitmap do not appear.
            /// </summary>
            public int yBitmap;
    }
